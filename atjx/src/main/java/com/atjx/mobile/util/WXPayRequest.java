...
import static com.atjx.mobile.util.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        IWXPayDomain.DomainInfo domainInfo = config.getWXPayDomain().getDomain((com.github.wxpay.sdk.WXPayConfig) config);
        if(domainInfo == null){
