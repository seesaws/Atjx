...
public class WXPay {
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        if (signTypeInData == null) {
            ...
            else if (com.github.wxpay.sdk.WXPayConstants.MD5.equals(signTypeInData)) {
                signType = WXPayConstants.SignType.MD5;
            }
            else if (com.github.wxpay.sdk.WXPayConstants.HMACSHA256.equals(signTypeInData)) {
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        String reqBody = com.github.wxpay.sdk.WXPayUtil.mapToXml(reqData);
    ...
    public Map<String, String> processResponseXml(String xmlStr) throws Exception {
        ...
        String return_code;
        Map<String, String> respData = com.github.wxpay.sdk.WXPayUtil.xmlToMap(xmlStr);
        ...
        if (return_code.equals(com.github.wxpay.sdk.WXPayConstants.FAIL)) {
            return respData;
        }
        else if (return_code.equals(com.github.wxpay.sdk.WXPayConstants.SUCCESS)) {
    ...
    public Map<String, String> downloadBill(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        if (respStr.indexOf("<") == 0) {
            ret = com.github.wxpay.sdk.WXPayUtil.xmlToMap(respStr);
        }
        else {
            // 正常返回csv数据
            ret = new HashMap<String, String>();
            ret.put("return_code", com.github.wxpay.sdk.WXPayConstants.SUCCESS);
